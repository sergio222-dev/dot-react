...
const Card = withSlots<CardSlots, HTMLAttributes<HTMLDivElement>>(
  ({
    slotProps,
    className,
    ...containerProps
    ...
    return (
      <div {...containerProps} className={cls(styles["card"], className)}>
        {slotProps.CardHeader && (
          <div {...slotProps.CardHeader}>{slotProps.CardHeader.children}</div>
        )}
        {slotProps.CardContent && (
          <div
            {...slotProps.CardContent}
            className={cls(
              styles["v1-card-content"],
              slotProps.CardContent.className
            )}
          >
